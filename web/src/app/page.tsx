        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link href="/signup">
                <Button size="sm" className="rounded-full shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all">
                  Start Free Trial
                </Button>
              </Link>
            </div>
        ...
        <div className="relative overflow-hidden bg-white">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 text-center">
            ...
            <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center gap-4">
               <Link href="/signup">
                  <Button size="lg" className="rounded-full shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all w-full sm:w-auto" rightIcon={<ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />}>
                    Get Started Free
                  </Button>
                </Link>
                <Link href="#demo">
                  <Button variant="outline" size="lg" className="rounded-full w-full sm:w-auto mt-4 sm:mt-0 border-2">
                    Book a Demo
                  </Button>
                </Link>
            </div>
            ...
            <div className="mt-20 relative max-w-5xl mx-auto">
               <div className="aspect-[16/9] rounded-2xl bg-slate-900 shadow-2xl border border-slate-800 overflow-hidden relative group">
                  <div className="absolute inset-0 bg-gradient-to-tr from-slate-800 to-slate-900 flex flex-col items-center justify-center transition-transform duration-700 group-hover:scale-105">
